...
from {{PYT_PKG_NAME}}.background import run_background
...
class Log:
    def __init__(self, subsystem="{{PYT_PKG_NAME}}", dd_mode=False, debug_mode=False):
    ...
    def log(self, kind, *args, **keys):
        if os.environ.get("BACKGROUND_LOGGING"):
